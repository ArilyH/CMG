...
class Population():
    ...
    def __init__(self, individuals, 
        ...
        self.preprocess = empty_processing
    ...
    def cal_cur_mmd(self, indvs, nes):
        ...
        for idx, ind in enumerate(indvs):
            ...
            # print(len(tmp_outputs))
            # print(len(tmp_outputs[-2]),tmp_outputs[-2][0].shape)
            sys.stdout.flush()
            mmds.append(cal_mmd.cal_mmd(tmp_outputs[-2], nes).cpu().detach().numpy())
            # print(sys.getsizeof(mmds))
            del tmp_outputs
        print("end")
        return mmds
    ...
    def evolvePopulation(self):
        ...
        # Serialize and write the variable to the file
            ...
            cnt+=len(self.individuals[self.min_idx])
