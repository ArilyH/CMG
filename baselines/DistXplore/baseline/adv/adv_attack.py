...
if __name__ == "__main__":
    ...
    model=torch.load("/home/ubuntu/hbl/LargeD/ProCMG/IN100/models/resnet50_IN100.pth",map_location=torch.device('cpu'))
    ...
    adv_seed_dir = "/home/ubuntu/hbl/LargeD/ProCMG/IN100/classwise_data_adv"
    all_class_adv_seeds = []
    ...
    for idx, class_data in enumerate(all_class_adv_seeds):
        ...
        if 1:
            ...
            for method in ["bim", "pgd"]:
                adv_save_dir = "/home/ubuntu/hbl/LargeD/ProCMG/IN100/DistXplore/baseline/adv/{}/".format(method)
                ...
                while(cnt<1300):
                    ...
                    if adv is not None:
                        ...
                        for advx in range(adv.shape[0]):
                            ...
                            img.save(os.path.join(end_save_dir,f'image_{index}.png'))
